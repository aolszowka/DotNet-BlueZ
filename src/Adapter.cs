...
namespace ProrepubliQ.DotNetBlueZ
{
    ...
    public class Adapter : IAdapter1, IDisposable
    {
        ...
        private async void FireEventForExistingDevicesAsync()
        {
            ...
            foreach (var device in devices) m_deviceFound?.Invoke(this, new DeviceFoundEventArgs(device, false));
        }

        private async void OnDeviceAdded(
